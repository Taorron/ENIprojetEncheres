...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    <a class="navbar-brand" href="${pageContext.request.contextPath}/IndexServlet">ENI-Enchères</a>
	...
	<c:choose>
	    <c:when test="${user!=null}">
			...
			<li class="nav-item">
				<a class="nav-link" href="${pageContext.request.contextPath}/IndexServlet?disconnect=">Déconnexion</a>
			</li>
	    </c:when>
	    <c:otherwise>
		    <li class="nav-item">
